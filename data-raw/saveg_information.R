  ...
  sa_vsf <- tibble::tribble(
    ...
    , 100, 1, "Grasses", "mid", "Tall closed grassland"
    , 70, 1, "Grasses", "mid", "Tall grassland"
    , 30, 1, "Grasses", "mid", "Tall open grassland"
    , 10, 1, "Grasses", "mid", "Tall very open grassland"
